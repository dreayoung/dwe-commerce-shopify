  ...
  return (
    <div className="flex flex-col space-y-20 py-24">
      <div className="relative flex h-40 items-center justify-center overflow-x-hidden text-center">
        ...
        <span className="absolute left-1/2 top-auto hidden -translate-x-1/2 transform whitespace-nowrap text-center text-5xl uppercase text-neutral-200 text-opacity-40 md:block md:text-8xl lg:text-[7rem]">
          Herotoall.io
        </span>
        <span className="words absolute top-auto block text-center text-8xl uppercase text-neutral-200 text-opacity-40 md:hidden">
          Herotoall.io
        </span>
      </div>
